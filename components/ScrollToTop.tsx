    ...
    <AnimatePresence>
      {isVisible && (
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={scrollToTop}
            className="fixed bottom-6 right-6 z-50 p-3 bg-white/10 [.light_&]:bg-blue-600/20 backdrop-blur-xl border border-white/20 [.light_&]:border-blue-600/30 text-white [.light_&]:text-blue-600 rounded-xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] [.light_&]:shadow-lg hover:shadow-[0_0_20px_rgba(79,209,255,0.4)] hover:border-[#4FD1FF]/50 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#4FD1FF]/50 group overflow-hidden"
