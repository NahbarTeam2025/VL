      ...
      <div className="flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1 w-full max-w-md lg:max-w-none">
          <div className="relative">
            <div className="absolute -inset-4 bg-accent-blue/20 blur-2xl rounded-full"></div>
        ...
        <div className="flex-1">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent-blue/10 text-accent-blue text-[10px] font-black uppercase tracking-widest mb-8 border border-accent-blue/20">
            DER EXPERTE HINTER DER TECHNIK
          </div>
          
          <h2 id="about-title" className="text-4xl md:text-6xl font-black mb-8 leading-tight">
            Über den <span className="text-accent-blue">Experten</span>
          </h2>
          ...
          <ul className="space-y-6" role="list">
            {[
              ...
              <li key={i} className="flex items-start gap-4">
                <div className="mt-1 p-1 bg-accent-blue/10 rounded-lg">
